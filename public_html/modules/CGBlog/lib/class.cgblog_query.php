...
class cgblog_query implements ArrayAccess
{
  // keys: showdraft|showall,sortby,sortasc,year,month,author|admin_user,category|notcategory|category_id,showarchive,pagelimit|number,
  //       start,pagenumber,detailtemplate,summarytemplate,detailpage,
