...
echo '<h3>'.$this->Lang('info_archive_templates').'</h3>';
echo $this->ShowTemplateList($id,$returnid,'archive',
			     'default_archive_template_contents',
			     'archive_template',
			     'current_archive_template',
			     $this->Lang('addedit_archive_template'));
