...
echo '<h3>'.$this->Lang('info_fesubmit_templates').'</h3>';
echo $this->ShowTemplateList($id,$returnid,'fesubmit',
			     'default_fesubmit_template_contents',
			     'fesubmit_template',
			     'current_fesubmit_template',
			     $this->Lang('addedit_fesubmit_template'));
