...
# Get the data
#
$categories = cgblog_ops::get_category_list(FALSE,null,TRUE);
...
#
$smarty->assign('add_category_url',$this->create_url($id,'admin_editcategory',$returnid));
$smarty->assign('default_category',$this->GetPreference('default_category'));

#
# Process The template
#
echo $this->ProcessTemplate('admin_categoriestab.tpl');
