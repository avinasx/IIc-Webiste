...
echo '<h3>'.$this->Lang('info_felist_templates').'</h3>';
echo $this->ShowTemplateList($id,$returnid,'felist',
			     'default_felist_template_contents',
			     'felist_template',
			     'current_felist_template',
			     $this->Lang('addedit_felist_template'));
