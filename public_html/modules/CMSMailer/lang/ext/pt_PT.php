<?php
$lang['warning_cron_updated'] = 'Este teste &eacute; gerado pouco frequentemente. Pode decorrer algum tempo antes de desaparecer.';
$lang['none'] = 'Nenhum';
$lang['ssl'] = 'SSL ';
$lang['tls'] = 'TLS ';
$lang['secure'] = 'Mecanismo de encripta&ccedil;&atilde;o';
$lang['info_secure'] = 'Aplic&aacute;vel apenas no m&eacute;todo SMTP, esta op&ccedil;&atilde;o permite especificar diferentes mecanismos de encripta&ccedil;&atilde;o para a conex&atilde;o';
$lang['info_cmsmailer'] = 'Este m&oacute;dulo &eacute; utilizado por v&aacute;rios outros m&oacute;dulos para facilitar o envio E-mails. Deve ser correctamente configurado de acordo com os requerimentos do seu alojamento. Por favor use as informa&ccedil;&otilde;es fornecidas pelo seu provedor de alojamento para ajustar estas defini&ccedil;&otilde;es. Se continuar a n&atilde;o conseguir enviar a mensagem de teste correctamente, pode ter de contactar o seu provedor de alojamento para assist&ecirc;ncia.';
$lang['charset'] = 'Definir Codifica&ccedil;&atilde;o de caracteres';
$lang['sendtestmailconfirm'] = 'Esta ac&ccedil;&atilde;o ir&aacute; enviar uma mensagem de teste para o endere&ccedil;o especificado. Se o processo for bem sucedido, retornar&aacute; a esta p&aacute;gina. Deseja continuar?';
$lang['settingsconfirm'] = 'Escrever os valores actuais nas configura&ccedil;&otilde;es do CMSMailer?';
$lang['testsubject'] = 'Mensagem de Teste do CMSMailer';
$lang['testbody'] = 'Esta mensagem apenas pretende verificar a validade das defini&ccedil;&otilde;es do CMSMailer.
Ao recebe-la significa que tudo est&aacute; a funcionar bem.';
...
$lang['smtpauth'] = 'Autentica&ccedil;&atilde;o SMTP';
$lang['mailer'] = 'M&eacute;todo Mailer';
$lang['host'] = 'Nome do SMTP host<br/><i>(ou endere&ccedil;o IP)</i>';
$lang['port'] = 'Porta do servidor SMTP';
$lang['from'] = 'Endere&ccedil;o de envio';
$lang['fromuser'] = 'Nome do Utilizador que envia';
$lang['sendmail'] = 'localiza&ccedil;&atilde;o do Sendmail';
$lang['timeout'] = 'SMTP tempo de espera m&aacute;ximo (timeout)';
$lang['submit'] = 'Submeter';
$lang['cancel'] = 'Cancelar';
$lang['info_mailer'] = 'M&eacute;todo Mail a usar (sendmail, smtp, mail).  Normalmente o smtp &eacute; o mais fi&aacute;vel.';
$lang['info_host'] = 'Hostnome SMTP (v&aacute;lido apenas para o m&eacute;todo smtp mailer)';
$lang['info_port'] = 'N&uacute;mero da porta SMTP (normalmente 25) (v&aacute;lido apenas para o m&eacute;todo smtp mailer)';
$lang['info_from'] = 'Endere&ccedil;o usado como o remetente em todos os e-mails.<br/><strong>Note</strong>, endere&ccedil;o de email deve estar correctamente configurado para o seu servidor (host) ou poder&aacute; experimentar dificuldades ao enviar emails.<br/>Se n&atilde;o conhece o valor correcto para esta defini&ccedil;&atilde;o,poder&aacute; ter de contactar o seu provedor de alojamento (host).';
$lang['info_fromuser'] = 'Nome amig&aacute;vel usado no envio de todos os emails';
$lang['info_sendmail'] = 'O caminho (path) completo para o execut&aacute;vel do sendmail (v&aacute;lido apenas para o m&eacute;todo sendmail mailer)';
...
$lang['info_username'] = 'Autentica&ccedil;&atilde;o username para SMTP (v&aacute;lido para o m&eacute;todo smtp mailer, quando o smtp auth for seleccionado)';
$lang['info_password'] = 'Autentica&ccedil;&atilde;o senha para SMTP (v&aacute;lido para o m&eacute;todo smtp mailer, quando o smtp auth &eacute; seleccionado)';
$lang['friendlyname'] = 'CMSMailer ';
$lang['postinstall'] = 'O m&oacute;dulo CMSMailer foi instalado com &ecirc;xito';
$lang['postuninstall'] = 'O m&oacute;dulo CMSMailer CMSMailer foi desinstalado';
$lang['uninstalled'] = 'M&oacute;dulo desinstalado.';
$lang['installed'] = 'M&oacute;dulo vers&atilde;o %s instalado.';
$lang['accessdenied'] = 'Acesso Negado. Por favor confirme as suas permis&otilde;es.';
$lang['error'] = 'Erro!';
$lang['upgraded'] = 'M&oacute;dulo actualizado para a vers&atilde;o %s.';
$lang['title_mod_prefs'] = 'Prefer&ecirc;ncias do M&oacute;dulo ';
$lang['title_mod_admin'] = 'Painel de Admin do M&oacute;dulo';
$lang['title_admin_panel'] = 'M&oacute;dulo CMSMailer';
$lang['moddescription'] = 'Trata-se de um simples inv&oacute;lucro em torno do PHPMail, tem uma API equivalente (fun&ccedil;&atilde;o a fun&ccedil;&atilde;o) e uma interface simples para algumas configura&ccedil;&otilde;es por defeito.';
$lang['changelog'] = '<ul>
