...
$lang['none'] = 'هيچ';
$lang['ssl'] = 'SSL حالت امن';
$lang['tls'] = 'TLS حالت امن';
$lang['secure'] = 'مکانیزم رمزگذاری';
$lang['info_secure'] = 'فقط مناسب با روش SMTP مي باشد،اين گزينه اجازه تعيين مكانيزم رمزگذاري هاي مختلف جهت اتصال را ميدهد';
$lang['info_cmsmailer'] = 'این ماژول جهت تسریع در امر ارسال ایمیل بسیاری از ماژول های دیگر استفاده میگردد.این ماژول باید بدرستی و متناسب با هاست شما تنظیم گردد. لطفاً از اطلاعات مهیا شده توسط میزبان جهت تنظیمات استفاده نمایید.اگر شما نمی توانید پیغام آزمایشی را بصورت راکد جهت ارسال صحیح نگه دارید، می توانید جهت راهنمایی با میزبان تماس حاصل نمایید.';
$lang['charset'] = 'تنظیم کاراکتر';
$lang['sendtestmailconfirm'] = 'این امکان می تواند یک &divide;یغام آزمایشی به آدرس مشخص شده ارسال نماید.اگر ارسال موفقیت آمیز بود، شما میتوانید به این صفحه مجددا باز گردید.آیا میخواهید ادامه دهید؟';
$lang['settingsconfirm'] = 'آیا مقادیر فعلی برای تنظیمات ارسال ایمیل ذخیره شود ؟';
$lang['testsubject'] = 'پیغام آزمایش ارسال ایمیل';
$lang['testbody'] = 'این پیغام تنها جهت تایید معتبر بودن تنظیمات مربوط به ماژول ارسال ایمیل می باشد.
.اگر شما این را دریافت کردید، همه چیز بدرستی کار میکند';
$lang['error_notestaddress'] = 'خطا : آدرس آزمایشی تعيين نشده است';
$lang['prompt_testaddress'] = 'آزمایش آدرس پست الکترونیک';
$lang['sendtest'] = 'ارسال پيام آزمايشی';
$lang['password'] = 'رمزعبور';
$lang['username'] = 'شناسه کاربری';
$lang['smtpauth'] = 'تصدیق SMTP';
$lang['mailer'] = 'روش های میلر';
$lang['host'] = 'نام میزبان SMTP<br/><i>(یا آدرس IP)</i>';
$lang['port'] = 'درگاه میزبان SMTP';
$lang['from'] = 'از آدرس';
$lang['fromuser'] = 'از شناسه کاربری';
$lang['sendmail'] = 'پوشه محل ارسال نامه';
$lang['timeout'] = 'وقفه ارسال SMTP';
$lang['submit'] = 'ارسال';
$lang['cancel'] = 'لغو';
$lang['info_mailer'] = 'روش میل جهت استفاده (sendmail, smtp, mail) .معمولاً SMTP مطمئن تر می باشد. ';
$lang['info_host'] = 'روش SMTP (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['info_port'] = 'درگاه SMTP (معمولا 25) (تنها برای روش ارسال از SMTP مورد قبول است)';
$lang['info_from'] = 'آدرس جهت ارسال برای تمامی ایمیل ها.  <br/><strong>متن</strong>, این آدرس ایمیل باید بدرستی برای میزبان تنظیم شود ، درغیر اینصورت مشکلاتی جهت ارسال ایمیل خواهید داشت.<br/> اگر شما از مقادیر صحیح جهت این تنظیمات اطلاع ندارید، شما باید با میزبان تماس حاصل نمایید.';
$lang['info_fromuser'] = 'نامی دوستانه جهت ارسال برای تمامی ایمیل ها';
$lang['info_sendmail'] = 'مسیر کامل جهت اجرای ارسال میل  (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['info_timeout'] = ' میزان وقفه برحسب ثانیه در هنگام رخداد خطا SMTP  (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['info_smtpauth'] = 'تصدیق درخواست SMTP شما در هنگام درخواست  (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['info_username'] = 'تصدیق شناسه کاربری SMTP  (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['info_password'] = 'تصدیق رمز عبور SMTP  (تنها برای روش ارسال از SMTP مورد قبول میباشد)';
$lang['friendlyname'] = 'سامانه ارسال ایمیل';
$lang['postinstall'] = 'سامانه ارسال ایمیل بدرستی نصب شد';
$lang['postuninstall'] = 'سامانه ارسال ایمیل بدرستی حذف شد...متاسفیم که دیگه شما رو نمیبینیم.';
$lang['uninstalled'] = 'ماژول حذف شده است.';
$lang['installed'] = ' نسخه ماژول نصب شده %s می باشد.';
$lang['accessdenied'] = 'دسترسی به این بخش مقدر نمی باشد.لطفا دسترسی خود را بررسی نمایید.';
$lang['error'] = 'خطا!';
$lang['upgraded'] = 'ماژول به نسخه %s بروزرسانی شد !';
$lang['title_mod_prefs'] = 'اولویت های ماژول';
$lang['title_mod_admin'] = 'بخش مدیریتی ماژول';
$lang['title_admin_panel'] = 'ماژول سامانه ارسال ایمیل';
$lang['moddescription'] = 'این ماژول برگرفته از PHPMailer میباشد، این ماژول میانجی(توابع برای توابع)و واسط کاربری مشابهی برای بیشتر پیشفرض ها دارا می باشد. ';
$lang['changelog'] = '<ul>
...
$lang['help'] = '<h3>چطور کار خواهد کرد؟</h3>
<p>این ماژول جهت بهره مندی نامحدود کاربران می باشد.این ماژول جهت بهره گیری درامکان ارسال ایمیل توسط سایر ماژول ها میباشد . نه چیز بیشتر. </p>
<h3>چطور از این استفاده کنیم</h3>
<p>این ماژول از تمامی توابع و رویداد های PHPMailer بهره گرفته است.این ماژول جهت استفاده برنامه نویسان دیگر ماژول ها طراحی شده، در پایین ما  یک مثال و یک کاربرد از کتابخانه میانجی ها داریم.جهت اطلاعات بیشتر می توانید از مستندات PHPMailer استفاده نمایید.</p>
<h3>یک مثال</h3>
<pre>
...
$lang['utma'] = '156861353.126206163.1339490496.1339490496.1339490496.1';
$lang['utmz'] = '156861353.1339490496.1.1.utmccn=(referral)|utmcsr=dev.cmsmadesimple.org|utmcct=/|utmcmd=referral';
$lang['utmb'] = '156861353';
$lang['utmc'] = '156861353';
?>